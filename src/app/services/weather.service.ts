import { ICurrentWeatherData } from './../interfaces/current-weather-data.interface';
...
export class WeatherService {
    ...
    getCurrentWeather(city: string, country: string): Observable<ICurrentWeather> {
        ...
        return this.httpClient
            ...
            .pipe(
                map(data => this.transformToICurrentWheather(data))
            );
    }

    transformToICurrentWheather(data: ICurrentWeatherData): ICurrentWeather {
        return {
            city: data.name,
